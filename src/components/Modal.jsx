                        ...
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-lg bg-neutral-900 p-6 text-left align-middle shadow-xl transition-all">
                                    <Dialog.Title
                                        as="h3"
                                        className="text-lg font-medium leading-6 text-neutral-50 pt-3 mr-6"
                                    >
                                        {title}
                                    </Dialog.Title>
                                    ...
                                    {/* close modal button */}
                                    <button
                                        className="absolute top-3 right-3 p-1 border border-neutral-800 hover:border-neutral-500 hover:transition rounded-lg"
                                        onClick={closeModal}
                                    >
